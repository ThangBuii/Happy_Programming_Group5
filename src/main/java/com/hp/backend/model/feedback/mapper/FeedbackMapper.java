...
public class FeedbackMapper {
    ...
    public FeedbackListAdminResponseDTO toFeedbackListResponseDTO(Feedback feedback)
        ...
        return FeedbackListAdminResponseDTO.builder().mentee_ava(mentee.getAvatar()).mentee_email(mentee.getEmail())
                ...
                .created_date(feedback.getTime()).content(feedback.getContent()).feedback_id(feedback.getFeedback_id())
    ...
    public FeedbackListMenteeResponseDTO toFeedbackListMenteeResponseDTO(Feedback feedback)
        ...
        return FeedbackListMenteeResponseDTO.builder().ava(mentor.getAvatar()).email(mentor.getEmail())
                .username(mentor.getUsername())
                .content(feedback.getContent()).created_date(feedback.getTime()).feedback_id(feedback.getFeedback_id())
                .rating(feedback.getRating()).build();
    }
    ...
    public FeedbackListMentorResponseDTO toFeedbackListMentorResponseDTO(Feedback feedback)
        ...
        return FeedbackListMentorResponseDTO.builder().ava(mentee.getAvatar()).email(mentee.getEmail())
