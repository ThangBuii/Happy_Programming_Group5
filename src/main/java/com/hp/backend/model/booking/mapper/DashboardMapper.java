...
public class DashboardMapper {
    ...
    public static DashboardMenteeDTO toBookingDTO(DashboardMenteeDTO book1) {
        return DashboardMenteeDTO.builder().username(book1.getUsername()).email(book1.getEmail())
                .created_Date(book1.getCreated_Date())
                .build();
    }

    public static DashboardMentorDTO toBookingMentorDTO(DashboardMentorDTO book1) {
        return DashboardMentorDTO.builder().username(book1.getUsername()).email(book1.getEmail())
                .created_Date(book1.getCreated_Date())
                .build();
    }
    ...
    public DashboardMenteeDTO findEmailAndUsernameByBookingID(int id) {
        ...
        return DashboardMenteeDTO.builder().username(account.getUsername()).email(account.getEmail())
                .created_Date(booking.getCreated_date()).status(booking.getStatus()).bookingID(id)
                .build();
    }
